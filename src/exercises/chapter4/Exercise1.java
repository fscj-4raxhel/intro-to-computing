...
/**
 * Rewrite Example_4_1 to sum ⅓ three hundred times, ¼ four hundred times and ⅛ eight hundred times. Comment on the results.
 * 
 * This class demonstrates the accumulated round-off error with different examples
 */
